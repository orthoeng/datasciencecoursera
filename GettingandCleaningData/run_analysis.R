...
##    of each variable for each activity and each subject.
        ...
        tidyDatamean <- variable_name[, grep("-mean\\(\\)" , colnames(variable_name))]

        ## Add label to activity labels
        colnames(merge_ydata) <- "Activity_Labels"

        ## Add columns 
        tidyData <- cbind(merge_ydata,tidyDatamean)
